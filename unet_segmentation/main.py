...
class encoding_block(nn.Module):
    def __init__(self, in_channels, out_channels, dropout_1,dropout_2):
        super(encoding_block, self).__init__()
        model = []
        model.append(nn.Conv2d(in_channels, out_channels, 3, 1, 1, bias=False))
        model.append(nn.BatchNorm2d(out_channels))
        model.append(nn.ReLU(inplace=True))
        model.append(nn.Dropout(dropout_1))
        model.append(nn.Conv2d(out_channels, out_channels, 3, 1, 1, bias=False))
        model.append(nn.BatchNorm2d(out_channels))
        model.append(nn.ReLU(inplace=True))
        model.append(nn.Dropout(dropout_2))
...
class unet_model(nn.Module):
    def __init__(self, out_channels=49, features=[64, 128, 256, 512]):
        ...
        self.conv1 = encoding_block(3, features[0], dropout_1, dropout_2)
        self.conv2 = encoding_block(features[0], features[1], dropout_1,dropout_2)
        self.conv3 = encoding_block(features[1], features[2], dropout_1,dropout_2)
        self.conv4 = encoding_block(features[2], features[3], dropout_1,dropout_2)
        self.conv5 = encoding_block(features[3] * 2, features[3], dropout_1,dropout_2)
        self.conv6 = encoding_block(features[3], features[2], dropout_1,dropout_2)
        self.conv7 = encoding_block(features[2], features[1], dropout_1,dropout_2)
        self.conv8 = encoding_block(features[1], features[0], dropout_1,dropout_2)
        self.tconv1 = nn.ConvTranspose2d(features[-1] * 2, features[-1], kernel_size=2, stride=2)
        self.tconv2 = nn.ConvTranspose2d(features[-1], features[-2], kernel_size=2, stride=2)
        self.tconv3 = nn.ConvTranspose2d(features[-2], features[-3], kernel_size=2, stride=2)
        self.tconv4 = nn.ConvTranspose2d(features[-3], features[-4], kernel_size=2, stride=2)
        self.bottleneck = encoding_block(features[3], features[3] * 2, 0, 0)
